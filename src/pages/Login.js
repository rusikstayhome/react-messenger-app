        ...
        <section>
            ...
            <form className="form" onSubmit={handleSubmit}>
                <div className="input_container">
                    ...
                    <input type="text" name='email' value={email} placeholder='test@test.com' onChange={handleChange} />
                </div>
                <div className="input_container">
                    <label htmlFor="password">Password</label>
                    <input type="text" name='password' value={password} placeholder='testtest' onChange={handleChange} />
                </div>
